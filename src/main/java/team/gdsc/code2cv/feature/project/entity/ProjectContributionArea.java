...
public class ProjectContributionArea {
    ...
    @Builder
    private ProjectContributionArea(ProjectAnalysis projectAnalysis, Integer commitsCount, Integer linesCount, String task, String detail) {
    ...
    public static ProjectContributionArea create(ProjectContributionAreaCreate command, ProjectAnalysis projectAnalysis) {
